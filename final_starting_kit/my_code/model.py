...
# IMPORTANT : Les tests sont présents dans ce fichier, juste après l'implémentation de la classe model.
...
# Toute cette partie va nous permettre de tester nos fonctions.
# A l'aide de la cross-validation on peut calculer le score obtenu par notre modèle prédictif, et ainsi
# voir son efficacité.
